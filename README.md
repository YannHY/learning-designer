...
- `APP_MAIL_FROM` et `APP_MAIL_FROM_NAME` pour l'expéditeur des emails de vérification. L'envoi utilise la fonction `mail()` de PHP, qui doit être activée sur l'hébergement.
